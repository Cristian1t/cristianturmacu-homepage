  ...
  return (
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          I&apos;m a passionate developer, always looking for new challenges and
          trying to improve my skills and learn new technologies.
        </Paragraph>
        {/* @ts-ignore */}
        ...
        <Paragraph>
          ...
          <NextLink href="/works/trueblue">
            <Link>TrueBlue</Link>
          </NextLink>
          , an italian company for digital solutions in the Customer Engagement,
          BI and Artificial Intelligence fields.
        </Paragraph>
      </Section>
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          Going to the gym, reading books, playing video games, watching movies
          and series, listening to music.
        </Paragraph>
      </Section>
    </Container>
  )
